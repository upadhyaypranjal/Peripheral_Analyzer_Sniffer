...
**Figure:** Complete architecture and signal flow of the multi-protocol hardware sniffer/analyzer. Raw UART and I²C signals generated by the ESP8266 are synchronized inside the Renesas ForgeFPGA SLG47910 using dedicated two-stage synchronizer chains before being forwarded as metastability-safe signals to the RP2040, where protocol decoding, frame reconstruction, monitoring, logging, and system-level analysis are performed.
